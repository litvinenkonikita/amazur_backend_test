...
FastAPI-сервис для управления `target_status` рекламных кампаний по иерархии правил из тестового задания. Требования из PDF реализованы как отдельные rule-компоненты с единым интерфейсом и журналированием вычислений.

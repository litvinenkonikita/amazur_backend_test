...
from app.models.common import Base, TimestampMixin, UUIDPrimaryKeyMixin, decimal_column, status_enum
...
class Campaign(Base, UUIDPrimaryKeyMixin, TimestampMixin):
    ...
    current_status = mapped_column(status_enum, nullable=False, default="active")
    target_status = mapped_column(status_enum, nullable=False, default="active")
